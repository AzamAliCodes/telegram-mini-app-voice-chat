    ...
    <div className="flex items-center justify-between py-3 border-b border-white/5 last:border-0 transition-all duration-300">
      <div className="flex items-center gap-3">
        <div className={clsx(
          ...
          isSpeaking ? "bg-gradient-to-tr from-emerald-400 to-green-500 shadow-[0_0_20px_rgba(16,185,129,0.4)]" : "bg-white/10"
        )}>
          ...
          {isSpeaking && (
            <>
              <div className="absolute inset-0 rounded-full animate-ping bg-emerald-400/60 -z-10" />
              <div className="absolute inset-0 rounded-full animate-pulse bg-emerald-400/30 -z-10 shadow-[0_0_15px_rgba(16,185,129,0.4)]" />
            </>
          )}
        </div>
        <div>
      ...
      <div className={clsx(
        ...
        {isMuted ? (
          ...
          <Mic className={clsx("transition-colors duration-300", isSpeaking ? "text-emerald-400" : "text-sky-400/60")} size={18} />
        )}
      </div>
    </div>
  );
